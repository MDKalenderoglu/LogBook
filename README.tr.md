...
- **Metin biçimlendirme** — araç çubuğundan kalın, italik, altı çizili, üstü çizili, vurgu ve üç kademeli başlık boyutu (⌘B/I/U); biçimli canlı önizleme ve yazı tipi seçimi. Biçim düz metin işaretleriyle saklanır; tarihçe, arama ve senkron aynen çalışır
